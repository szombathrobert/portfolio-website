export const projectsData = [
  {
    ...
    features: [
      "Gyors és érthető weblap azok számára akik szeretnének fülbelövést babáknak és/vagy gyerekeknek, vagy pedig felnőttek szeretnének piercinget, fülbevalót.",
      "Letisztult, bizalomgerjesztő dizájn a célközönségnek",
      "Villámgyors és sima one-page weboldal",
      "Teljesen reszponzív kialakítás (mobilra és asztali gépre optimalizálva)",
      "Könnyen áttekinthető szolgáltatások és árazás"
    ]
  },
  {
    id: "nyitott-ter",
    ...
    features: [
        "A megrendelő igénye az volt, hogy mindenki megértse a kezelés lényegét és hogy mire való",
        "Admin bejelentkezés",
        "Egyedi Admin panel (CMS) a tartalom egyszerű szerkesztéséhez",
        "Dinamikus esemény- és vizsgálatkezelés az ügyfél által",
        "Kiváló SEO eredmények a Next.js Server-Side Rendering révén",
    ]
  },
  {
    id: "oxigenkamra",
    ...
    features: [
      "Elmagyarázni, hogy mire is való pontosan a hiperbárikus oxigénterápia és mire és mikor javasolt használni",
      "Modern, letisztult vizuális megjelenés",
      "Kiváló teljesítmény (Lighthouse 100/100) a Next.js-nek köszönhetően",
